package BenchMarking.BenchmarkProgramming;

import Resource.EmbeddedGraphDB;
import Resource.QueryUtil;
import Resource.UpdateUtil;
...
public class clientProgram {
    ...
    public clientProgram(RepositoryConnection connection) {
    ...
    public void loadData() throws RepositoryException, IOException, RDFParseException {
        ...
        connection.add(clientProgram.class.getResourceAsStream("/family-ontology.ttl"), "urn:base", RDFFormat.TURTLE);

        // Adding some family data
        connection.add(clientProgram.class.getResourceAsStream("/family-data.ttl"), "urn:base", RDFFormat.TURTLE);
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        clientProgram familyRelations = new clientProgram(connection);
